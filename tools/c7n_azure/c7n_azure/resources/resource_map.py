...
ResourceMap = {
    ...
    "azure.spring-app": "c7n_azure.resources.spring_app.SpringApp",
    "azure.spring-service-instance": "c7n_azure.resources.spring_service_instance.SpringServiceInstance", # noqa
